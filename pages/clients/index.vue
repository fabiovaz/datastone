<script setup>
  ...
  const addClient = async () => {
    currentClient.value = { id: null, active: false, name: null, document: null, phone: null, email: null }
            ...
            <tbody>
              <tr v-for="client in clients" class="border-b dark:border-gray-700">
                ...
                <td class="px-4 py-3 flex items-center justify-end">
                  ...
                  <button @click.prevent="deleteClient(client.id)" class="font-medium text-red-600 dark:text-red-500 hover:underline ms-3">Deletar</button>
                </td>
              </tr>
            </tbody>
          </table>
